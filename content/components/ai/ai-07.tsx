...
export default function Ai07() {
  ...
  return (
    <div className="mx-auto flex h-[600px] w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-lg">
      {/* Header */}
